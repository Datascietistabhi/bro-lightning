...
* bitcoin/ - brocoin script, signature and transaction routines.
...
* external/ - external libraries from other sources
  ...
  - libwally-core - brocoin helper library
  - secp256k1 - brocoin curve encryption library within libwally-core
