...
def test_withdraw(node_factory, bitcoind):
    ...
    for i in range(10):
        l1.brocoin.rpc.sendtoaddress(addr, amount / 10**8 + 0.01)
    ...
    waddr = l1.brocoin.rpc.getnewaddress()
    ...
    sync_blockheight(l1.brocoin, [l1])
    ...
    bitcoind.generate_block(1)
    sync_blockheight(l1.brocoin, [l1, l2])
...
def test_withdraw_nlocktime(node_factory):
    ...
    nlocktime = node_factory.brocoind.rpc.decoderawtransaction(tx)["locktime"]
    tip = node_factory.brocoind.rpc.getblockcount()
