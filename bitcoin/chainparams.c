...
const struct chainparams networks[] = {
    {.network_name = "brocoin",
     ...
     .lightning_hrp = "br",
     .bip70_name = "main",
     .genesis_blockhash = {{{.u.u8 = {0x65,0xfd,0x03,0xb3,0x63,0x6e,0x55,
                                      0xc4,0xe3,0x6d,0xca,0x9c,0x4c,0xe6,
                                      0x2d,0xc6,0x6e,0x03,0x75,0x20,0xc3,
                                      0x19,0x4b,0xe7,0xe6,0xe2,0xb0,0x6a,
                                      0x9a,0x08,0x00,0x00}}}},
     .rpc_port = 8997,
     .cli = "brocoin-cli",
     .cli_args = NULL,
    ...
    {.network_name = "regtest",
     ...
     .lightning_hrp = "rbr",
     .bip70_name = "regtest",
     .genesis_blockhash = {{{.u.u8 = {0x6d,0xfa,0xed,0x84,0x1c,0x6b,0x56,
                                      0x2d,0x08,0xe3,0x8f,0x09,0xb0,0x1f,
                                      0x13,0x6b,0xa2,0x9c,0xc3,0xf0,0xf9,
                                      0x80,0x9c,0xd8,0xb3,0xeb,0x51,0x5b,
                                      0x0c,0x28,0x8d,0x6d}}}},
     .rpc_port = 18324,
     .cli = "brocoin-cli",
     .cli_args = "-regtest",
    ...
    {.network_name = "testnet",
     ...
     .lightning_hrp = "tbr",
     .bip70_name = "test",
     .genesis_blockhash = {{{.u.u8 = {0x18,0x17,0xc7,0x92,0xed,0xd3,0xea,
                                      0x1c,0x48,0xf4,0x1d,0x4f,0xa3,0x8c,
                                      0xef,0x98,0xca,0x9e,0xa2,0x3f,0xd4,
                                      0xb5,0x9a,0x46,0xc2,0x50,0x2f,0x7a,
                                      0x22,0x09,0x00,0x00}}}},
     .rpc_port = 18755,
     .cli = "brocoin-cli",
     .cli_args = "-testnet",
