...
class BitcoinRpcProxy(object):
    ...
    def _handle_request(self, r):
        brpc = BitcoinProxy(btc_conf_file=self.brocoind.conf_file)
        method = r['method']
    ...
    def start(self):
        ...
        logging.debug("BitcoinRpcProxy proxying incoming port {} to {}".format(self.rpcport, self.brocoind.rpcport))
